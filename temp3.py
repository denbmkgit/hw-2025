...
# # Добавление видео
# # ur.add(v1, v2)
# ur.register('Max', 'parol', 18)
# ur.register('vasya_pupkin', 'lolkekcheburek', 13)
#
# # print(int(ur.users[0].get('vasya_pupkin')[-3:])==13) # вытащили возраст равный 13 по nickname (self.users.append({f'{nickname}': f'{password}, {age}'}))
# # print(ur.users)
# # print(ur.users[0].get('vasya_pupkin'))
# ur.log_in('vasya_pupkin', 'lolkekcheburek')
